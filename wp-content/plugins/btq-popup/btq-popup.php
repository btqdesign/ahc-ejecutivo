 ...
 * Plugin URI: https://ejecutivo.idevol.net/wp-content/plugins/btq-popup/btq-popup.html
			...
			<div class="modal-content">
				...
				<div style="padding: 0px;" class="modal-body">
					<?php if (isMobile == false): ?>
						...
						<?php endif; ?>
						<?php if ($language == 'es'): ?>
						<a href="https://hotelelejecutivo.com.mx/es/beneficios/"><img src="<?php echo plugins_url( 'imagenes/body_mob.jpg', __FILE__ ); ?>" alt="Top 5 razones por las que conviene reservar."></a>
						<?php else: ?>
						<a href="https://hotelelejecutivo.com.mx/en/benefits/"><img src="<?php echo plugins_url( 'imagenes/body_mob_en.jpg', __FILE__ ); ?>" alt="Top 5 reasons why you should book."></a>
						<?php endif; ?>
					...
					<?php else: ?>
						...
						<?php endif; ?>
						<?php if ($language == 'es'): ?>
						<a href="https://hotelelejecutivo.com.mx/es/beneficios/"><img src="<?php echo plugins_url( 'imagenes/body_web.jpg', __FILE__ ); ?>" alt="Top 5 razones por las que conviene reservar."></a>
						<?php else: ?>
						<a href="https://hotelelejecutivo.com.mx/en/benefits/"<?php echo plugins_url( 'imagenes/body_web_en.jpg', __FILE__ ); ?>" alt="Top 5 reasons why you should book."></a>
						<?php endif; ?>
